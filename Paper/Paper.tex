...
\begin{abstract}
\noindent In Reinforcement Learning an Agent learns how to behave in an environment just by interacting with it.
This is a test for citation \cite{Ac_lecture}
\end{abstract}
}
